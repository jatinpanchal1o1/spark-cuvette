...
function FeatureSection({
  ...
  const contentSection = (
    <div
      className={`${reversed ? "ml-2" : ""} ${contentWidth} max-md:ml-0 max-md:w-full`}
    >
  ...
  const imageSection = (
    ...
    >
      <div
        className={`flex grow items-start px-2 py-2 w-full ${backgroundColor} rounded-[32px] max-md:px-5 max-md:mt-8`}
      >
